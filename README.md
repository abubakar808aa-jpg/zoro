...
The web app includes a mixed `/feed`: authenticated users can publish, like, and comment on community posts, while career news is displayed as short RSS previews that link to the original publisher. Configure optional sources through `NEWS_RSS_FEEDS`.
