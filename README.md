...
The web app includes a mixed `/feed`: community activity from people a user follows plus short previews from official BLS, Federal Reserve, Census, and DOL feeds that link to the original publisher. Each source reports health separately, and JobMan never reproduces full articles.
