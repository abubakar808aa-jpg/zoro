  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="card">
          <button onClick={handleGoogle} disabled={loading} className="btn-google mb-6">
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          ...
          <Link href="/sign-up" className="text-primary-600 font-semibold hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  );
