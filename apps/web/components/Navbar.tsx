...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/90 backdrop-blur-sm border-b-2 border-ink sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2.5 group">
            <img src="/logo.svg" alt="JobMan" className="w-9 h-9 group-hover:-rotate-12 transition-transform" />
          ...
          <div className="flex items-center gap-3">
            {user ? (
              <>
                <Link href="/messages" className="relative p-2 text-slate-600 hover:text-ink hover:bg-acid-200 rounded-full transition-colors">
